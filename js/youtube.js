...
$.ajax({
    ...
    data:{
        part:"snippet", 
        key:"AIzaSyBRz4U1bY9MXg6WqEnDlsadOnowPnHNjm4", 
        maxResults : 6,  
        playlistId: "PLm27PraOXEz8DqjKrywWJKJRT-QPwXSwD" 
    }
})
...
$("body").on("click",".asmrList article" ,function(e){
    e.preventDefault();
    var vidSrc = $(this).find(".pic").attr("href");
    $(".asmrPop").fadeIn();
    $(".asmrPop .inner").append(
        $("<iframe>").attr({
...
$("body").on("click", ".asmrPop span", function(){
...
$.ajax({
    ...
    data:{
        ...
        key:"AIzaSyBRz4U1bY9MXg6WqEnDlsadOnowPnHNjm4", 
        maxResults : 6,  
        playlistId: "PLm27PraOXEz8JUjQ1obxzGNQEFi6fN4Xd" 
    }
})
.success(function(data){
    console.log(data.items);
